...
public class BestScorers extends ServerResource {
    ...
    protected Representation get() throws ResourceException {
        ...
        String year = getMandatoryAttribute("Year", "Year is missing");
        ...
        try {
            ...
            List<PlayerData> result = dataAccess.getBestScorers(year);
            return format.generateBestScorers(result);
        } catch (Exception e) {
